...
const ArrowIcon = ({ expanded }) => (
  <svg
  className={`w-6 h-6 ml-3 text-lg transition-transform ${
    expanded ? 'transform rotate-90 text-orange-500 text-lg' : 'text-white text-lg'
  }`}
  ...
  return (
    <div>
      ...
      >
        ...
        Got <span className="text-[#FF451D] font-bold">Questions? </span>{" "}
           <br />
           We've Got Answers!
        </h1>
